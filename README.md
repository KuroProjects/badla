...
~~~
git clone https://github.com/KuroProjects/badla.git && cd shell-bot
npm install
~~~
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/KuroProjects/badla)
